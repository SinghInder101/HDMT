...
@Component({
  ...
  providers:[authService,createHiringDriveService,listHiringDriveService,editHiringDriveService,manageHiringDriveService,manageCandidateService,managePanelistService,listAllHiringDriveandIDService]
})
